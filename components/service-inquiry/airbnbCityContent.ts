...
const AIRBNB_CITY_COPY: Record<string, AirbnbCityCopy> = {
  ...
  frederiksberg: {
    ...
    editorialParagraphs: [
      ...
      "På Frederiksberg er detaljerne særligt vigtige: stuk og paneler skal støvtørres, trægulve skal behandles korrekt, og badeværelser i ældre ejendomme kræver ekstra opmærksomhed på fuger og armaturer. Vores Zenmestre kender disse boligtyper og arbejder metodisk, så intet springes over i jagten på at nå næste check-in.",
      ...
      "Mange værter på Frederiksberg kombinerer kortidsudlejning med egen bolig i samme ejendom. Vi arbejder diskret og respekterer naboer og sameje — så du kan drive din udlejning uden unødig opmærksomhed.",
  ...
  gentofte: {
    ...
    editorialParagraphs: [
      ...
      "Større boliger kræver mere tid og struktur: flere badeværelser, større køkken og eventuelt terrasse eller have, der skal være præsentabel. Vi planlægger opgaven ud fra kvadratmeter og antal værelser, så turn-around-tiden er realistisk — også når gæsterne checker ud kl. 10 og næste ankomst er samme eftermiddag.",
  ...
  aarhus: {
    ...
    editorialParagraphs: [
      ...
      "Aarhus C og de centrale kvarterer har mange boliger i ældre ejendomme med fælles trapper og baggårde. Vores Zenmestre arbejder diskret og respekterer naboernes ro — samtidig med at boligen gøres grundigt klar. Det er særligt vigtigt i lejligheder tæt på Strøget og Latinerkvarteret, hvor gæster ofte ankommer sent og forventer alt at være perfekt.",
  ...
  odense: {
    ...
    editorialParagraphs: [
      ...
      "Odense centrum har mange charmerende lejligheder i ældre bygninger, mens forstæderne byder på større boliger med have. Vi tilpasser klargøringen til begge typer — fra kompakt city-lejlighed til familiebolig i Hjallese — og sikrer, at gæsten møder det samme høje niveau uanset adresse.",
  ...
  aalborg: {
    ...
    editorialParagraphs: [
      ...
      "Aalborgs havnefront og centrum har mange nyere lejligheder med store vinduespartier, der kræver ekstra opmærksomhed. Vi kan tilføje vinduespudsning som tilvalg, så gæsterne får den udsigt, de bookede efter. I ældre ejendomme omkring Jomfru Ane Gade er det om at holde bad og køkken i top — uanset hvor travlt det er i byen.",
  ...
  roskilde: {
    ...
    editorialParagraphs: [
      ...
      "Roskilde Festival-ugen er ekstrem for mange værter: gæster checker ud tidligt om morgenen, og næste booking kan være samme dag. Vi har erfaring med høj turnover og planlægger ekstra tid, når du fortæller os om travle perioder i forespørgslen.",
      "Pendlerophold og weekendbookinger fylder også kalenderen — særligt i lejligheder tæt på stationen. Gæsterne forventer en bolig, der fungerer som et hjem: rent køkken, friske håndklæder og en seng, der er redt. Det leverer vi hver gang.",
  ...
  helsingoer: {
    ...
    editorialParagraphs: [
      ...
      "Turister i Helsingør besøger ofte Kronborg, havnen og Sverigefærgen — og bruger boligen som base for hele Øresund-området. De forventer en skandinavisk ren standard, når de vender hjem efter en lang dag. Vi sørger for, at entré, køkken og bad signalerer velkommen fra første øjeblik.",
      ...
      "I vinterhalvåret kan belægningen falde, men gæster der booker jul eller nytår ved Øresund forventer stadig topstandard. Renzen er klar, når du har gæster — uanset sæson.",
